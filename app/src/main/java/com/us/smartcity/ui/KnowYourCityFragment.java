...
import com.us.smartcity.knwur_city.HistoricalPlace;
import com.us.smartcity.knwur_city.TouristInfo;
import com.us.smartcity.knwur_city.TrafficDetail;

/**
 * Created by Bhaskar on 25-10-2015.
 */
public class KnowYourCityFragment extends FragmentActivity implements TabListener {
    ...
    String[] tabsName = {"Historical Place", "Tourist Info", "Traffic Info"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.know_your_city_fragment);
